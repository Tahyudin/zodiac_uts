...
public class tes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ((Integer.parseInt(date1)>21 && Integer.parseInt(month) == 6) || (Integer.parseInt(date1)<=20 && Integer.parseInt(month) == 7)){
            ...
            isi_zodiak.setText("Orang yang lahir pada tanggal antara 22 Juni sampai 20 Juli dikatakan bernaung di bawah zodiak Cancer, yang berlambang Kepiting.");
        ...
        if ((Integer.parseInt(date1)>23 && Integer.parseInt(month) == 9) || (Integer.parseInt(date1)<=22 && Integer.parseInt(month) == 10)){
            ...
            isi_zodiak.setText("Orang yang lahir pada tanggal antara 22 September sampai 22 september dikatakan bernaung di bawah zodiak Libra, yang berlambang Alat Penimbang (Dacin).");
        ...
        if ((Integer.parseInt(date1)>23 && Integer.parseInt(month) == 10) || (Integer.parseInt(date1)<=22 && Integer.parseInt(month) == 11)){
            ...
            isi_zodiak.setText("Orang yang lahir pada tanggal antara 22 Oktober sampai 22 November dikatakan bernaung di bawah zodiak Scorpio, yang berlambang kalajengking.");
        ...
        if ((Integer.parseInt(date1)>23 && Integer.parseInt(month) == 11) || (Integer.parseInt(date1)<=20 && Integer.parseInt(month) == 12)){
            ...
            isi_zodiak.setText("Orang yang lahir pada tanggal antara 20 November sampai 20 Desember dikatakan bernaung di bawah zodiak Sagitarius, yang berlambang Pemanah. ");
